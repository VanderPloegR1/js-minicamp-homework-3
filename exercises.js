...
function makeCat(name, age) {
  ...
  //return the object
  var newCat = {name:name,age:age,meow:function(){return'Meow!';}
};
  return newCat;
}
...
function newUser(name, email, password) {
  ...
  var newObject = {name: name, email: email, password: password};
  return newObject;
}
...
function sumUserPostLikes(user) {
  ...
  //return the sum
  var sum =0;
  for (var i = 0; i < user.posts.length; i++) {sum += user.posts[i].likes;
  }
  return sum;
}
